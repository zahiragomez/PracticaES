...
#Funcion que actualiza un grafico de dispersion con la recta de regresion y el intervalo de confianza
...
#Funcion que calcula el coeficiente de determinacion (R cuadrado)
